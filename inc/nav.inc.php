    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($isAdmin): ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?= appUrl('/admin/index.php') ?>">
                ...
                <?php if ($navUser): ?>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                            ...
                            <?php if ($isAdmin): ?>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item text-danger" href="<?= appUrl('/admin/index.php') ?>"><i class="bi bi-shield-lock me-2"></i>Admin Dashboard</a></li>
                            <?php endif; ?>
                            <li><hr class="dropdown-divider"></li>
