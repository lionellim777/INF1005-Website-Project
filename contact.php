...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['form_action'] ?? '') === 'contact_form') {
    ...
    if (!csrf_verify($_POST['csrf_token'] ?? null)) {
        ...
        if ($errors === []) {
            ...
            if ($mailResult['sent']) {
                $session->set_flashdata('success', 'Thanks for reaching out. We sent a confirmation email to your inbox.');
                ...
                <div class="col-lg-7">
                    <div class="support-form-card">
                        ...
                        <?php if (isset($errors['form'])): ?>
                            <div class="alert alert-danger mt-2 mb-3"><?= h($errors['form']) ?></div>
                        <?php endif; ?>
                        ...
                        <form id="contact-form" method="post" class="row g-3 mt-1" novalidate>
                            ...
                            <div class="col-12">
                                ...
                                <select id="inquiry_type" name="inquiry_type"
                                    class="form-select<?= isset($errors['inquiry_type']) ? ' is-invalid' : '' ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="name" name="name" type="text" minlength="2" maxlength="100"
                            ...
                            <div class="col-12">
                                ...
                                <input id="subject" name="subject" type="text" minlength="3" maxlength="150"
                            ...
                            <div class="col-12 d-flex flex-column flex-sm-row gap-3 align-items-sm-center">
                                <button id="contact-submit" type="submit" class="btn text-white px-4" style="background-color: #28666e;">Send message</button>
                                <small class="text-muted">You will only see success after your confirmation email is sent.</small>
                            </div>
                            <div class="col-12">
                                <div class="support-policy-note mt-2">
