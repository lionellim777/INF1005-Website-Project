...
try {
    ...
    $summary = ['total_orders'=>5,'total_revenue'=>4833,'avg_order'=>966.6];
}
...
<head>
    ...
    <title>Sales Analytics – Employee – Pomegranate</title>
...
<div class="dash-wrapper">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="analytics.php" class="sidebar-link active"><i class="bi bi-bar-chart-line"></i> Sales Analytics</a>
    ...
    <div class="dash-main">
        ...
        <div class="dash-content">
            <div class="mb-4">
                ...
                <p class="text-white-50 small mb-0">Revenue trends, top products, and category performance.</p>
            </div>
            ...
            <!-- Category doughnut + top products bar -->
            <div class="row g-3 mb-4">
        ...
        new Chart(catCanvas, {
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        position: 'bottom',
                        labels: { color:'rgba(255,255,255,.5)', padding:14, font:{size:11}, boxWidth:10, usePointStyle:true }
                    },
                    tooltip: {
                        backgroundColor:'#0c1220', borderColor:'rgba(255,255,255,.08)', borderWidth:1,
