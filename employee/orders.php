...
<head>
    ...
    <title>Orders – Employee – Pomegranate</title>
    ...
    <div class="dash-main">
        ...
        <div class="dash-content">
            <div class="mb-4">
                ...
                <p class="text-white-50 small mb-0">Read-only view of customer orders.</p>
            </div>
            ...
            <div class="dash-table-wrap">
                ...
                <div style="overflow-x:auto;">
                    <table class="dash-table">
                        ...
                        <tbody>
                            <?php if (empty($orders)): ?>
                            <tr><td colspan="7" class="text-center text-white-50 py-4">No orders found.</td></tr>
                            <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-white-50" style="font-size:.72rem;">@<?= h($o['username']) ?></div>
                                </td>
                                <td class="text-white-50" style="font-size:.8rem;"><?= h($o['email']) ?></td>
