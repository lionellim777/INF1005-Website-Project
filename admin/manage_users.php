...
<head>
    ...
    <title>Admin – Users – <?= SITE_NAME ?></title>
        ...
        <div class="container">
            ...
            <?php if ($isOffline): ?>
                <div class="alert alert-info small">
                    Offline demo mode is active. User management actions are simulated in session.
                </div>
            <?php endif; ?>

            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h3 class="fw-bold mb-0"><i class="bi bi-shield-lock me-2"></i>User Management</h3>
                    <small class="text-muted"><?= count($allUsers) ?> user(s) found</small>
                </div>
                <a href="<?= appUrl('/auth/dashboard.php') ?>" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <form method="GET" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            <button type="submit" class="btn text-white w-100" style="background-color:#28666e;">
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="" class="d-inline">
                                            ...
                                            <select name="new_role_id" class="form-select form-select-sm d-inline-block w-auto"
                                                ...
                                                <?php foreach ($roles as $r): ?>
                                                    <option value="<?= $r['role_id'] ?>" <?= (int)$u['role_id'] === (int)$r['role_id'] ? 'selected' : '' ?>>
                                                        <?= ucfirst($r['role_name']) ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
